...
# File paths
HITTER_FILE = "../data/hitter_games.csv"  # Input file with hitter data
ID_MAP_FILE = "../data/hitter_games_with_gamepk.csv"  # File with game_pk
WEATHER_PARK_FILE = "../data/weather_and_park_factors.csv"
