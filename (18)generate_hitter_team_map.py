...
MAP_FILE   = FilePaths.HITTER_GAMES_WITH_GAMEPK
OUT_FILE   = FilePaths.HITTER_TEAM_MAP
...
def normalize_name(s) -> str:
    if pd.notna(s) and str(s).strip():
        ...
        # Remove punctuation, suffixes, extra spaces, and handle middle initials
        return (
            s.strip()
            .lower()
            .replace(".", "")
...
def main():
    ...
    # Filter df_stats for hitters based on Position
