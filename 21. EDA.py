...
print("SWAP: Loading all feature files...")
...
print(f"DATA: Base hitters: {hitters_base.shape}")
print(f"DATA: Season features: {hitter_season.shape}")  
print(f"DATA: Rolling features: {hitter_rolling.shape}")
print(f"DATA: Weather/park: {weather_park.shape}")
print(f"DATA: Team mapping: {hitter_team_map.shape}")

# Filter rolling data to most recent date FIRST
from datetime import datetime, timedelta
recent_date = hitter_rolling['date'].max()
print(f" Using rolling features from: {recent_date}")
...
print("SWAP: Merging all features using PLAYER NAMES...")

# Start with base data and filter to hitters only  
enhanced_hitters = hitters_base[hitters_base['Position'] != 'P'].copy()
print(f"DATA: Filtered to hitters: {enhanced_hitters.shape}")
...
print("SWAP: Merging season data by names...")
...
print("SWAP: Merging rolling data by names...")
...
print("WARNING: Skipping weather data (requires game_pk matching)")

print(f"SUCCESS: Enhanced hitters shape after name merging: {enhanced_hitters.shape}")
...
print("SWAP: Converting columns to numeric...")
...
print("\nDATA: Data types after conversion:")
...
print("\nSWAP: Creating advanced batting statistics...")
...
if 'hits_season' in enhanced_hitters.columns and 'atBats_season' in enhanced_hitters.columns:
    ...
    print("SUCCESS: Created season_avg")
...
if 'hits_rolling' in enhanced_hitters.columns and 'atBats_rolling' in enhanced_hitters.columns:
    ...
    print("SUCCESS: Created rolling_avg")
...
if 'homeRuns_season' in enhanced_hitters.columns and 'atBats_season' in enhanced_hitters.columns:
    ...
    print("SUCCESS: Created season_hr_rate")
...
if 'homeRuns_rolling' in enhanced_hitters.columns and 'atBats_rolling' in enhanced_hitters.columns:
    ...
    print("SUCCESS: Created rolling_hr_rate")
...
if 'rbi_season' in enhanced_hitters.columns and 'atBats_season' in enhanced_hitters.columns:
    ...
    print("SUCCESS: Created season_rbi_rate")

print(f"\nDATA: Enhanced hitters shape after cleanup: {enhanced_hitters.shape}")

# SUCCESS: PRESERVE ESSENTIAL PLAYER IDENTIFICATION COLUMNS
...
analysis_columns = [
    # SUCCESS: ESSENTIAL PLAYER INFO (MUST KEEP!)
...
print(f"\nSWAP: Converting statistical columns to numeric:")
...
print(f"\nTARGET: Final enhanced dataset: {final_dataset.shape}")
print(f"INFO: Selected analysis columns: {list(final_dataset.columns)}")
...
print("SUCCESS: Saved enhanced features with player info to: ../data/hitters_enhanced_features_with_info.csv")

print("COMPLETE: Enhanced EDA complete!")
...
print(f"SUCCESS: Player info columns: {essential_in_final}")
