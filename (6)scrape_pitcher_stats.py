...
END_DATE = "2025-07-13"    # Current date
...
def get_pitcher_game_logs(player_id, start_date=START_DATE, end_date=END_DATE):
    url = f"https://statsapi.mlb.com/api/v1/people/{player_id}/stats?stats=gameLog&group=pitching&sportId=1&season=2025&startDate={start_date}&endDate={end_date}"
