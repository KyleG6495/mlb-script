...
logging.info(f"✅ Loaded {len(proj)} proj rows; sample IDs: {proj['player_id'].unique()[:5].tolist()}")
...
logging.info(f"ℹ️ Parsed {slate['player_id'].nunique()} unique player_ids from 'Id'")
