...
def fix_with_confirmed_starters():
    ...
    print("TARGET: CONFIRMED STARTING PITCHERS FOR TODAY:")
    ...
    print("START: All players now use CONFIRMED starting pitchers and active position players!")
    print("SUCCESS: No more NS (Not Starting) or PO (Probable Out) issues!")
