...
def convert_lineups_to_fanduel_format():
    ...
    input_file = FilePaths.DATA_DIR / f'enhanced_lineups_today_{today_str}.csv'
    ...
    output_file = FilePaths.FD_CURRENT_SLATE_DIR / f'Lineups_Ready_To_Submit_{today_str}.csv'
