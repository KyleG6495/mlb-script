...
print('SUCCESS: PrizePicks file reads successfully!')
...
print('\nTARGET: SAMPLE OF ACTUAL STRIKEOUT DATA:')
...
print()
print('TARGET: This explains our arbitrage opportunities!')
print('DATA: But we need to verify if these are the SAME games/props')