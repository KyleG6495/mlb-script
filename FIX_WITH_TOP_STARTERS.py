...
def fix_with_top_starters():
    ...
    print("🎯 TOP 5 CONFIRMED STARTING PITCHERS:")
    ...
    print(f"\n🔄 USING THESE TOP 2 STARTERS FOR ALL LINEUPS:")
    ...
    for i, old_pitcher_id in enumerate(current_pitcher_ids):
        ...
        if old_pitcher_id in updated_content:
            ...
            if not old_pitcher.empty and not new_pitcher.empty:
                print(f"✅ Replaced {old_pitcher.iloc[0]['First Name']} {old_pitcher.iloc[0]['Last Name']} with {new_pitcher.iloc[0]['First Name']} {new_pitcher.iloc[0]['Last Name']}")
    ...
    print("🚀 ALL LINEUPS NOW USE TOP-TIER CONFIRMED STARTERS!")
    print("✅ Paul Skenes and Robbie Ray are guaranteed starting today!")
