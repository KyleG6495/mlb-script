...
def fix_pitcher_starting_status():
    ...
    print("TARGET: CONFIRMED STARTING PITCHERS (Probable Pitcher = Yes):")
    ...
    print("START: ALL PITCHERS NOW CONFIRMED STARTERS - NO MORE NS STATUS!")
    
    # Also list the final confirmed pitchers being used
    print(f"\nSUCCESS: FINAL PITCHER ROSTER:")
