...
def create_betting_action_sheet():
    ...
    df = pd.read_excel(r'C:\Users\kgone\OneDrive\Personal_Information\MLB\data\line_discrepancies_20250719_172504.xlsx')
...
def save_betting_sheet(betting_df):
    ...
    # Save Excel file
    excel_file = rf"C:\Users\kgone\OneDrive\Personal_Information\MLB\data\BETTING_ACTIONS_{timestamp}.xlsx"
