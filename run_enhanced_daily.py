...
def run_daily_analysis():
    ...
    print("START: DAILY ENHANCED FANDUEL ANALYSIS")
    print("=" * 50)
    ...
    try:
        ...
        print("SUCCESS: Enhanced system complete")
    except Exception as e:
        print(f"ERROR: Enhanced system failed: {e}")
    
    # Run standard system  
    print("\nDATA: Running Standard System...")
    try:
        result = subprocess.run(['python', '23. optimize_fanduel_lineup.py'], 
                               capture_output=True, text=True, cwd='.')
        print("SUCCESS: Standard system complete")
    except Exception as e:
        print(f"ERROR: Standard system failed: {e}")
    ...
    try:
        ...
        if os.path.exists('../data/todays_stacked_lineup.csv'):
            ...
            if 'Projected_FPPG' in standard_df.columns:
                ...
                print(f"DATA: Standard System: {standard_score:.1f} FPPG")
    ...
    print("TARGET: Recommendation: Use enhanced lineups for maximum edge!")
