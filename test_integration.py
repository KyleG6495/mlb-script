...
def test_integration():
    ...
    print("\n1️⃣ Testing Underdog data loading...")
    ...
    if os.path.exists(ud_excel):
        ...
        print(f"✅ Underdog Excel loaded: {len(df)} players, {len(df.columns)-2} stat types")
    ...
    if pp_files:
        ...
        print(f"✅ PrizePicks loaded: {len(df_pp)} players from {pp_file}")
    ...
    if os.path.exists(ud_excel):
        ...
        print(f"✅ Underdog conversion: {len(df_long)} prop lines after melting")
    ...
    if pp_files:
        ...
        print(f"✅ PrizePicks conversion: {len(df_pp_long)} prop lines after melting")
